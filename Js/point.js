...
function setup() {
  ...
  flyBoxColors.push(color('#0f4b49'));
  flyBoxColors.push(color('#0e6b51'));
  flyBoxColors.push(color('#0a9857'));
  flyBoxColors.push(color('#5cd352'));
  flyBoxColors.push(color('#d9ff57'));
}
