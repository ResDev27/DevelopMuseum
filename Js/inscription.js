...
function setup() {
  ...
  flyBoxColors.push(color('#483155'));
  flyBoxColors.push(color('#6d3c62'));
  flyBoxColors.push(color('#a35175'));
  flyBoxColors.push(color('#ea748a'));
  flyBoxColors.push(color('#ffa99d'));
}
